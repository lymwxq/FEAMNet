...
def generate_traindata(traindata_all, traindata_label, input_size, label_size, batch_size,
...
def data_augmentation(traindata_batch, traindata_label_batchNxN, batch_size):
